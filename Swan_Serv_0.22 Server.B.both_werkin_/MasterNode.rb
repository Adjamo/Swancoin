...
require_relative './Modules/many_line_pub_key.rb'
...
# puts response
    ...
    key_extract_1 = response.split(",")
    key_extract_2 = key_extract_1[2]

    puts ""
    puts "here"
    # puts response + " :)"
    # user_public_key = many_line_pub_key(key_extract_2)
    # puts user_public_key
    puts "there"
    puts ""
